...
class AlphaVantage:
    def __init__(self, apiKey):
        self.urlPath = f"https://www.alphavantage.co/query?apikey={apiKey}&outputsize=full&function="
    ...
    def getTimeSeries(self, stock_ticker) -> Dict:
        ...
        try:
            response = requests.get(url="%sTIME_SERIES_DAILY&symbol=%s" % (self.urlPath, stock_ticker),
